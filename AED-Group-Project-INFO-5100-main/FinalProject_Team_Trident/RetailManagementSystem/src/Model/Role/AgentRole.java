...
import userinterface.CustomerAgentWorkArea.CustomerAgentWorkAreaJPanel;
...
public class AgentRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, 
            ...
            EcoSystem business) {
        return new CustomerAgentWorkAreaJPanel(userProcessContainer, account,organization,enterprise,network,business);
       // return null;
    ...
    public String toString(){
        return (RoleType.AgentRole.getValue());
    }
