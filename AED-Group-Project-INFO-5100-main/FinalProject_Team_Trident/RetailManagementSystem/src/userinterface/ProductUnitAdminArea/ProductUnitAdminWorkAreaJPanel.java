...
public class ProductUnitAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    EcoSystem ecosystem;
    public ProductUnitAdminWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise, EcoSystem ecosystem) {
        initComponents();
