...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
        for (Location location : system.getLocationList()) {
    ...
    private void initComponents() {
        ...
        add(locationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(249, 197, 200, 29));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/imageedit_1_9446566363.png"))); // NOI18N
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 630, 540));
    }// </editor-fold>//GEN-END:initComponents

    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed

        if(locationJComboBox.getSelectedItem().equals("Select") || enterpriseTypeJComboBox.getSelectedItem().equals("Select"))
        {
            JOptionPane.showMessageDialog(null, "Please select Type and Network!");
            return;
        }
        Location network = (Location) locationJComboBox.getSelectedItem();
